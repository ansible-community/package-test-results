...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `5.3.0` of `theforeman.foreman`, corresponding to the `v5.3.0` tag in this repo, fails one or more of the required sanity tests.
...
The test `ansible-test sanity --test yamllint` [[explain](https://docs.ansible.com/ansible-core/devel/dev_guide/testing/sanity/yamllint.html)] failed with 115 errors:
...
tests/test_playbooks/fixtures/image-0.yml:307:11: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-1.yml:17:15: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-2.yml:370:11: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-3.yml:307:11: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-4.yml:17:15: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-5.yml:17:15: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-6.yml:17:15: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
tests/test_playbooks/fixtures/image-7.yml:17:15: unparsable-with-libyaml: could not determine a constructor for the tag 'tag:yaml.org,2002:python/unicode'
