...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `5.2.0` of `kubernetes.core`, corresponding to the `5.2.0` tag in this repo, fails one or more of the required sanity tests.
