...
The test `ansible-test sanity --test yamllint` [[explain](https://docs.ansible.com/ansible-core/devel/dev_guide/testing/sanity/yamllint.html)] failed with 4 errors:

``` text
.zuul.yaml:268:14: unparsable-with-libyaml: could not determine a constructor for the tag '!encrypted/pkcs1-oaep'
