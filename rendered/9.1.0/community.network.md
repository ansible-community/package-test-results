...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `5.0.2` of `community.network`, corresponding to the `5.0.2` tag in this repo, fails one or more of the required sanity tests.
