...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `3.4.11` of `community.docker`, corresponding to the `3.4.11` tag in this repo, fails one or more of the required sanity tests.
