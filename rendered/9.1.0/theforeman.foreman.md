...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `3.15.0` of `theforeman.foreman`, corresponding to the `v3.15.0` tag in this repo, fails one or more of the required sanity tests.
