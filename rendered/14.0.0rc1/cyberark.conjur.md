...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `1.3.9` of `cyberark.conjur`, corresponding to the `v1.3.9` tag in this repo, fails one or more of the required sanity tests.
...
secrets.yml:2:17: unparsable-with-libyaml: could not determine a constructor for the tag '!var'
```
