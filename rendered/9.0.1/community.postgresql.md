...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `3.2.0` of `community.postgresql`, corresponding to the `3.2.0` tag in this repo, fails one or more of the required sanity tests.
