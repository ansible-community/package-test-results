...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `2.18.2` of `cisco.meraki`, corresponding to the `v2.18.2` tag in this repo, fails one or more of the required sanity tests.
