...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `4.2.0` of `theforeman.foreman`, corresponding to the `v4.2.0` tag in this repo, fails one or more of the required sanity tests.
...
The test `ansible-test sanity --test yamllint` [[explain](https://docs.ansible.com/ansible-core/devel/dev_guide/testing/sanity/yamllint.html)] failed with 122 errors:
