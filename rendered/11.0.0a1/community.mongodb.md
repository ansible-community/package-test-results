...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `1.7.6` of `community.mongodb`, corresponding to the `1.7.6` tag in this repo, fails one or more of the required sanity tests.
