...
As per the [Ansible community package inclusion requirements][ci-testing], collections must pass `ansible-test sanity` tests. Version `1.0.30` of `cyberark.pas`, corresponding to the `1.0.30` tag in this repo, fails one or more of the required sanity tests.
