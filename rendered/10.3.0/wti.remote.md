...
The test `ansible-test sanity --test yamllint` [[explain](https://docs.ansible.com/ansible-core/2.17/dev_guide/testing/sanity/yamllint.html)] failed with 4 errors:
